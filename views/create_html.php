...
<p>Mise en page : <u>relative</u> (suite de blocs) - <a href="<?php print __CA_URL_ROOT__."/index.php/labelMaker/Models/CreateFloating/results/".$vs_table_name; ?>">basculer en mise en page absolue (glisser/redimensionner/positionner)</a></p>
...
<p>
    ...
    <button id="formGenerateSettingsSubmit">Générer HTML</button>
    <button id="formGeneratePDFSettingsSubmit">Générer PDF</button>
</p>
...
<script>
    ...
    $("#formGenerateSettingsSubmit").on("click", function(event) {
        event.preventDefault();
        $("#formPreviewSettings").attr("action", "<?php print __CA_URL_ROOT__."/index.php/labelMaker/Models/Generate/results/".$vs_table_name; ?>");
        $("#formPreviewSettings").submit();
    });
    $("#formGeneratePDFSettingsSubmit").on("click", function(event) {
        event.preventDefault();
        $("#formPreviewSettings").attr("action", "<?php print __CA_URL_ROOT__."/index.php/labelMaker/Models/GeneratePdf/results/".$vs_table_name; ?>");
        $("#formPreviewSettings").submit();
    });
